...
int main()
{
	...
	{
		team1.AddCharacter({ tex_width,tex_height }, SetTexture(renderer, "Player.png"), 10.f, false, warriorsLength, { StartPosX, StartPosY }, { 500.f , 72.5f }, renderer, SetFont("Gemstone.ttf", 18), { 128, 128, 128 });
	...
	for (int i = 0; i < CHARACTERS_COUNT; i++)
	{
		team2.AddCharacter({ tex_width,tex_height }, SetTexture(renderer, "enemy.png"), 10.f, false, archersLength, { StartPosX, StartPosY }, { 300.f , 112.5f }, renderer, SetFont("Gemstone.ttf", 18), { 128, 128, 128 });
	...
	board.defaultImage.Init({ 0,0 }, { tex_width , tex_height }, SetTexture(renderer, "Cell_obstacle.png"));
	board.obstacleImage.Init({ 0,0 }, { tex_width , tex_height }, SetTexture(renderer, "Cell.png"));
