...
int main()
{
	...
	Image characterImage;
	characterImage.Init({ 0,0 }, { tex_width,tex_height }, SetTexture(surface, renderer, "Player.png"));
	...
	Image enemyImage;
	enemyImage.Init({ 0,0 }, { tex_width,tex_height }, SetTexture(surface, renderer, "enemy.png"));
	...
	board.obstacleTexture = SetTexture(surface, renderer, "Cell_obstacle.png");
	board.defaultTexture = SetTexture(surface, renderer, "Cell.png");
